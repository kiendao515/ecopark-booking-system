...
function createData(name, residentID, idNumber, amount, date) {
  return {
    name,
    residentID,
    idNumber,
...
function EnhancedTableHead(props) {
  ...
  return (
    <TableHead className='Tan-tableHead'>
      <TableRow >
...
const EnhancedTableToolbar = (props,members) => {
...
const rows=[];
 data.forEach(i=>{
   if(i.user!==null)
   rows.push(createData(i.user.name,i.user.residentID,i.user.identifyNumber,i.amount,i.time))
 })
  ...
  return (
    <Box className='Tan-box' sx={{width:'98%', ml:'3%', borderRadius:'40px', filter: 'drop-shadow(0px 4px 4px rgba(0, 0, 0, 0.25))' }}>
      <Paper sx={{width:'100%' , mb: 2,  }}sx={{ borderRadius:'40px'}}>
